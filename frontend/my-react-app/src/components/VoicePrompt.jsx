...
const VoicePrompt = ({ onTranscript, disabled }) => {
  ...
  // Create toggleListening as a useCallback to prevent infinite loops
  ...
  }, [isListening, error, disabled]);

  // Set up volume analyzer function
  const setupVolumeAnalyzer = async () => {
    try {
